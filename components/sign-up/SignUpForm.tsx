...
const trackGAEvent = (eventName: string, eventParams: Record<string, any> | undefined) => {
  if (
...
function SignUpFormComponent() {
    ...
    return (
        ...
        >
            <div
                className="flex flex-col justify-center md:grid md:grid-cols-3 mt-16 lg:mt-[6.25rem] gap-4 w-full md:gap-8">
                <JHInput
                    id="firstname"
            ...
            <div className="flex flex-col justify-center md:grid md:grid-cols-3 mt-4 gap-4 w-full md:gap-8">
                ...
                <MultiselectDropdown
                    ...
                    onValueChange={(selected: string[]) => setField("community", selected)}
                />
                {values.community?.includes("hispanic") && (
                    <MultiselectDropdown
                        ...
                        label={
                            <span>
                              Language <small className="text-sm text-gray-400">(for Hispanic community)</small>
                            </span>
                        }
            ...
            <div className="flex flex-wrap justify-center gap-x-4 my-12 text-sm">
                {consents.map((c: ConsentData) => {
                    return (
                        ...
                        >
                            {c.id && countryCodeMap[c.id] ? getUnicodeFlagIcon(countryCodeMap[c.id]) : ""} {c.id}
                        </button>
                    );
                })}
            </div>
        ...
        <div className="flex flex-row gap-4">
            ...
            <div className="flex flex-col my-12 text-xs">
                <div className="flex flex-row items-center gap-2">
                    {id && countryCodeMap[id] ? getUnicodeFlagIcon(countryCodeMap[id]) : ""}{" "}
                    {id}
                    <button
