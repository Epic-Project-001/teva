    ...
    return (
        <div className="h-full flex flex-col items-center justify-center px-6 w-full max-w-[75rem] mx-auto">
            ...
            <p className="mt-5 text-2xl leading-9 text-center text-balance">
                ...
                and raise awareness about research studies in your community. Select the community that represents you
                to receive information tailored to your interests.
            </p>
            <SignUpForm/>
